...
def perform_statistical_analysis():
    """
    Performs statistical analysis on DR-annotated persuasion technique datasets.

    - Loads pooled PT-DR annotated datasets.
    - Computes frequency tables, PPMI scores, and Fisher's Exact Test.
    - Identifies statistically significant PT-DR associations.
    - Saves contingency tables, PPMI tables, and global summaries as Excel and text files.
    - Produces global PPMI heatmaps and significance heatmaps.

    Output is saved under ../results/stage3_statistical_analysis.
    """
