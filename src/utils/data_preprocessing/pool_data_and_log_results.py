...
def pool_data_and_log_results():
    direct_path = os.path.join('../', 'results', "stage2_DR_parsing_of_PT_annotated_semeval_datasets", "02_hallucination_removed")
    report_path = os.path.join('../', 'results', "stage2_DR_parsing_of_PT_annotated_semeval_datasets", "data_pooling_summary.txt")
    output_path = os.path.join('../', 'results', "stage2_DR_parsing_of_PT_annotated_semeval_datasets", "03_pooled_datasets")
