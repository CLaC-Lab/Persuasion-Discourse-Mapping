...
def extract_semeval_PT_data():
    """
    Extracts SemEval persuasion technique (PT) annotations from raw text files and labels.

    - Reads PT labels and corresponding paragraph texts.
    - Creates a structured JSON dataset with PT annotations.
    - Saves the processed dataset as a JSON file.

    File paths are predefined; no input arguments required.
    """
