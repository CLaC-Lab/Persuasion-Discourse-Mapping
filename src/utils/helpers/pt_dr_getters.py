"""
This module provides utility functions and mappings for handling
persuasion techniques (PT) and discourse relations (DR).

Includes:
- ID-to-name and name-to-ID lookup for PTs and DRs.
- Level-2 DR metadata including names and descriptions.

Used for preprocessing and mapping annotations in NLP pipelines.
"""
